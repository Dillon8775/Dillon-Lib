...
public class QuesoItemIds {
    ...
    public static final ResourceKey<Item> QUESO_BOAT = create("queso_boat");
    public static final ResourceKey<Item> QUESO_CHEST_BOAT = create("queso_chest_boat");
    ...
    private static ResourceKey<Item> create(String id) {
        return ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(QuesoExamplePlatformGetter.get().modId(), id));
    }
}