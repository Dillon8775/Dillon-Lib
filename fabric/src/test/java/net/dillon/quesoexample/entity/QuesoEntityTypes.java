...
public class QuesoEntityTypes {
    public static final EntityType<Boat> QUESO_BOAT = Factories.registerBoatFactory(
            Identifier.fromNamespaceAndPath(QuesoExampleMod.MOD_ID, "queso_boat"), EntityTypesInvoker.registerModBoatFactory(() -> QuesoTestItems.QUESO_BOAT), false);

    public static final EntityType<ChestBoat> QUESO_CHEST_BOAT = Factories.registerBoatFactory(
            Identifier.fromNamespaceAndPath(QuesoExampleMod.MOD_ID, "queso_chest_boat"), EntityTypesInvoker.registerModChestBoatFactory(() -> QuesoTestItems.QUESO_CHEST_BOAT), true);
